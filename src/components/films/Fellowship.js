...
export default function Fellowship() {
    return(
        <>
            <Nav />
            <h3 className="detail">The Fellowship of the Ring</h3>
            <img src='https://images.bauerhosting.com/legacy/media/61b3/96ab/d603/e8f4/962f/75e5/fellowship.jpg?q=80&auto=format&w=850&ar=16:9&fit=crop&crop=top' className="por-full" alt="Fellowship of the Ring" />
